...
export declare const isMaterialPass: (x: string) => x is "beauty" | "normals" | "depth" | "customColor" | "customEmissive" | "customRoughnessMetalnessHeight" | "customTopDownHeight" | "pointLights";
